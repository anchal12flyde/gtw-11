    ...
    <>
      ...
      <section className="terms-section util-mx-1-5">
        <div className="terms-container">
          ...
          <p>
            This website is operated by Knowledge Gate. Throughout the site, the
            terms “we”, “us” and “our” refer to Knowledge Gate. Knowledge Gate
            ...
            acceptance of all terms, conditions, policies and notices stated her
          </p>
          <p>
          ...
          {/* Online Store Terms */}
          <h2 className="terms-heading">Online Store Terms</h2>
          <p>
          ...
          <h2 className="terms-heading">GENERAL CONDITIONS</h2>
          <p>
          ...
          <h2 className="terms-heading">PRODUCTS OR SERVICES</h2>
          <p>
          ...
          <h2 className="terms-heading">OPTIONAL TOOLS</h2>
          <p>
