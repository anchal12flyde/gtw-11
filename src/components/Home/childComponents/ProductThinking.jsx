...
export default function ProductThinking() {
  const fadeLeftToRight = {
    hidden: { opacity: 0, x: -50 }, // left side se start
    visible: { opacity: 1, x: 0 }, // apni jagah par aa jaega
  };
    ...
    <section className="feature-section util-flex util-flex-1 util-mx-1-5 mt-26 mb-26">
      ...
      >
        ...
        <div>
          ...
          <p className="feature-subtitle">
            We help you refine scope, not just ship tasks
          </p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <p className="feature-subtitle">
            iOS + Android from a single, native-feeling codebase
          </p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <p className="feature-subtitle">
            From first deploy to v2, we are with you at every build stage
          </p>
        </div>
      </motion.div>
    </section>
