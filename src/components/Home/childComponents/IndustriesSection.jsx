    ...
    return (
      <div className='util-flex util-flex-1 util-mx-1-5'>
        <section className="mt-26 mb-26 md:mb-0">
          <h2 className="heading-systems text-secondary mb-12">Industries We Power</h2>
            ...
            {industryList.map((title, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="consumer-product pb-0 md:pb-6 md:flex md:justify-between md:items-start sm:border-b sm:border-primary"
                >
