  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 bg-white pt-14 md:pt-0 ">
      <div className=" mx-auto px-4 lg:px-0 ">
        <div className="text-left ml-0 sm:ml-20 mb-12">
        ...
        <div className="flex items-center justify-center w-full ">
          <div className="usecases-grid1">
            <div className="relative rounded-2xl overflow-hidden transform transition-transform duration-500 hover:scale-105 h-[500px] w-[350px]">
