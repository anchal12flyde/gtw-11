...
export default function ShopifyMagento() {
     ...
     return (
       <>
         <div className="bg-gray-light  py-20  mt-26">
               ...
               <div className="flex-shrink-0 snap-start w-[90vw]  flex flex-col md:flex-row gap-12 ">
                 ...
                 <div className="w-full sm:w-[30vw] flex flex-col justify-end mb-8">
                   ...
                   <p className="text-gray-dark2">
                     We offer clarity-first consulting backed by execution
                     capability. Whether you’re exploring modernization or ready
                     to rebuild, we guide you from map to momentum.
                   </p>
                 </div>
               </div>
