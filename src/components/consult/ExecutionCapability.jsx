    ...
    <>
      <div className="bg-gray-light util-flex util-flex-1 util-mx-1-5 mt-14 usecases-section">
        <div className="timeline-wrapper">
          <h4 className="text-[24px] font-semibold text-secondary  mb-8 lg:mb-[-30px]">
            What We Do
          </h4>
          <div className="timeline">
            ...
            {timelineItems.map((item, index) => (
              <div className="timeline-item mt-18" key={index}>
                <div className="flex flex-col lg:flex-row items-left gap-6 lg:gap-70">
                  <div className="timeline-image order-1 lg:order-2">
                    <img src={item.image} alt="" className="object-contain w-full h-full "/>
                  </div>
                  <div className="timeline-content order-2 lg:order-1">
                    <h3>{item.title}</h3>
