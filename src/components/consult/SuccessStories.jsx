        ...
        <div className="flex flex-nowrap gap-10  ">
          <div className=" yellow-container ">
            <div className="flex flex-col gap-8 bg-white-color1 rounded-3xl w-70 lg:w-80 h-[400px] overflow-hidden ">
              ...
              <div className="flex flex-col gap-4 px-8">
                <h3 className="ecom-heading text-left">EzStays</h3>
                <p className="paragraph-default">
                  Reimagined student housing ops across admissions, transport,
                  finance, and food resulting in 60% process efficiency gain.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-8 bg-white-color1 rounded-3xl w-70 lg:w-80 flex-shrink-0 h-[400px] overflow-hidden">
            ...
            <div className="flex flex-col gap-4 px-4">
              <h3 className="ecom-heading text-left">AuditChef</h3>
              <p className="paragraph-default ">
                Designed a compliance platform for a real estate company now
                rolled out across 20+ construction sites with live snag
                tracking.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col  bg-white-color1 rounded-3xl w-70 lg:w-80 flex-shrink-0 h-[400px] overflow-hidden ">
            <div className="relative rounded-2xl">
              <HoverVideo src="/videos/vd2.mp4" />
            </div>
            <div className="flex flex-col gap-4 px-8">
